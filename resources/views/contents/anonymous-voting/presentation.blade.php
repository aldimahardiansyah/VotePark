...
<body>
    ...
    <div class="timer-modal" id="timerModal">
        ...
        <div class="timer-candidate-name" id="timerCandidateName">Timer Orasi Calon</div>
        ...
        <div class="timer-settings">
            ...
            <div>
                ...
                <select id="soundWarning">
                    ...
                    <option value="60,30,10">60, 30, 10 detik</option>
                    <option value="10,5,3">10, 5, 3 detik</option>
                    <option value="10">10 detik saja</option>
                    <option value="30,10">30, 10 detik</option>
    ...
    <script>
        ...
        function updateCandidateName() {
            ...
            const name = select.value || 'Timer Orasi Calon';
