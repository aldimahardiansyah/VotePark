<div wire:poll.3s="refreshStats">
    ...
    <div class="event-info text-center mb-4">
    ...
    <div class="stats-row">
        ...
        <div class="stat-item">
            <div class="stat-value">{{ number_format($totalNpp, 4) }}%</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4">
            ...
            <div class="row justify-content-center">
                @forelse ($candidates as $candidate)
                    <div class="col-md-{{ count($candidates) <= 3 ? '4' : '3' }} mb-3">
                        <div class="candidate-card">
                            ...
                            <div class="mt-3">
                                <div class="vote-count">{{ number_format($candidate['total_npp'], 4) }}%</div>
        ...
        <div class="col-lg-5">
            ...
            <div class="leaderboard-container" style="max-height: 500px; overflow-y: auto;">
                @forelse ($leaderboard as $index => $candidate)
                    <div class="leaderboard-item">
                        ...
                        <div class="leaderboard-votes">
                            <div>{{ number_format($candidate['total_npp'], 4) }}%</div>
